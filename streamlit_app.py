...
my_query_results = my_query_results.merge(df_departement.rename({'INSEE_CODE': 'DEPT_CODE'}, axis=1).set_index(['DEPT_CODE'], verify_integrity=True), on = ['DEPT_CODE'], how='left')
